...
(function (d) {
	...
	var m = d.fn.dataTable,
		...
		q = m.ext.buttons,
		r = function (a, b) {
			if (!(this instanceof r)) return function (b) {
	...
	r.instanceSelector = function (a, b) {
		if (a === n || null === a) return d.map(b, function (a) {
			return a.inst
		});
		var c = [],
	...
	r.buttonSelector = function (a, b) {
		for (var c = [], e = function (a, b, c) {
					...
					if (d.isArray(a) || a instanceof d)
						...
						for (h = 0, f = k.length; h < f; h++) c.push({
							inst: b,
							node: k[h].node
						});
						...
						else if (a.match(/^\d+(\-\d+)*$/)) h = d.map(k, function (a) {
						return a.idx
					}), c.push({
						inst: b,
						...
						for (a = a.replace(":name", ""), h = 0, f = k.length; h < f; h++) k[h].name === a && c.push({
							inst: b,
							node: k[h].node
						});
					...
					else "object" === typeof a && a.nodeName && (k = d.inArray(a, h), -1 !== k && c.push({
						inst: b,
						node: h[k]
					}))
				},
