<div class="page-header">
    <h4 class="page-title">Ubah Data Pertanyaan Fire Alarm</h4>
            ...
            <form method="post" autocomplete="off" id="submit">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control input-pill" id="id_kuesioner" name="id_kuesioner" value="<?= $firealarm->id_kuesioner ?>">
                        <textarea class="form-control" id="pertanyaan" rows="3" name="pertanyaan"><?= $firealarm->pertanyaan ?></textarea>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        $('#submit').submit(function(e) {
            ...
            $.ajax({
                url: '<?= site_url(); ?>kuesioner/prosesEditKuesFirealarm',
                type: "post",
