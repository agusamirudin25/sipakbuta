                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control input-pill" id="jabatan" name="jabatan" required>
                            ...
                            <option value="SPV" <?= ($petugas->jabatan == 'SPV' ? 'selected' : null) ?>>SPV</option>
                            <option value="SIE" <?= ($petugas->jabatan == 'SIE' ? 'selected' : null) ?>>SIE</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="bagian">Bagian</label>
                        <input type="text" class="form-control input-pill" id="bagian" placeholder="Bagian" name="bagian" readonly value="<?= $petugas->bagian ?>" required>
                    </div>
                    <div class="form-group">
...
<script>
    $(document).ready(function() {
        $('#submit').submit(function(e) {
            ...
            $.ajax({
                url: '<?= site_url(); ?>main/prosesEditPengguna',
                type: "post",
        ...
        $('#jabatan').change(function(e) {
            e.preventDefault();
            if ($('#jabatan').val() == 'SPV') {
                $('#bagian').val('Supervisor');
            } else if ($('#jabatan').val() == 'SIE') {
                $('#bagian').val('Junior technician');
            } else {
                $('#bagian').val('');
            }
        });
