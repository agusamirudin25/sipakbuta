<div class="page-header">
    <h4 class="page-title">Rekapitulasi APAR</h4>
        ...
        <form method="post" id="submit">
            <div class="card card-post card-round">
                <div class="card-header">
                    <div class="card-title">Lihat Rekapitulasi APAR</div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
...
<div class="col-md-12">
    <div class="card card-post card-round">
        <div class="card" id="isi" hidden>
            <h2 id="judul" class="text-center mt-3">DATA REKAPITULASI MONITORING APAR BULAN </h2>
            <table class="table mt-2">
                <thead>
                    <tr>
                        <th scope="col">No</th>
                        <th scope="col">No APAR</th>
                        <th scope="col">Zona (Penempatan)</th>
    ...
    $(document).ready(function() {
        $('#cari').click(function() {
            ...
            $.ajax({
                ...
                data: "bulan=" + month + "&tahun=" + year + "&code=1",
                cache: false,
                dataType: "json",
                success: function(data) {
                    ...
                    if (data.kondisi == 1) {
                        ...
                        $('#link-pdf').attr("href", "<?= base_url() ?>pdf/" + month + "/" + year + "/1");
                        $('#link-excel').attr("href", "<?= base_url() ?>excel/" + month + "/" + year + "/1");
                        $('#link-pdf').attr("target", "_blank");
                        $('#link-excel').attr("target", "_blank");
                    }
                }
            });
            $('#judul').html('<b>DATA REKAPITULASI MONITORING APAR' + '<br>' + 'BULAN ' + bulan + ' TAHUN ' + year + '</b>');
