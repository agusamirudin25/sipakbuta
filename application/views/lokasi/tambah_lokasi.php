            ...
            <form method="post" autocomplete="off" id="submit">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control input-pill" id="nama" placeholder="Nama Lokasi" name="nama_lokasi" required>
                    </div>
...
<script>
    $(document).ready(function() {
        $('#submit').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: '<?= site_url(); ?>lokasi/prosesTambahLokasi',
                type: "post",
